...
import CreateExamModal from '../../components/admin/exams/CreateExamModal';
import QuestionPaperBuilder from '../../components/admin/exams/QuestionPaperBuilder';
import AssignExamModal from '../../components/admin/exams/AssignExamModal';
...
const Exams = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      // Fetch exams for the admin's department
