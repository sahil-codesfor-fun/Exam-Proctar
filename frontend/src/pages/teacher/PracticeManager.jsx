      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          ...
          <div className="col-span-full py-12 text-center border-2 border-dashed border-gray-200 rounded-2xl">
            ...
            <button onClick={() => navigate('create')} className="bg-white border border-gray-200 hover:border-emerald-500 text-gray-700 px-5 py-2.5 rounded-xl font-bold text-xs uppercase tracking-widest shadow-sm transition-all flex items-center gap-2 mx-auto">
...
const PracticeManager = () => {
  return (
    <Routes>
      ...
      <Route path="create" element={<PracticeSheetEditor />} />
      <Route path="edit/:id" element={<PracticeSheetEditor />} />
    </Routes>
  );
};
