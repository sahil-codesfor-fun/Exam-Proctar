    ...
    <div className="min-h-screen w-full flex flex-col bg-[#F8FAFC] font-sans text-slate-800 relative overflow-hidden">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-6 py-3 flex flex-col lg:flex-row gap-8 lg:gap-12 items-center lg:items-center justify-center lg:justify-between z-10 relative lg:min-h-0">
        ...
        <section className="w-full lg:w-[50%] flex flex-col justify-center py-4 h-full">
          ...
          <div className="mt-5 lg:mt-6 flex flex-col sm:flex-row items-center sm:items-end gap-4 justify-center lg:justify-start">
            <img 
              src={about1} 
            ...
            />
            {/* Info Banner */}
            <div className="bg-[#0F172A] text-white p-3 sm:p-4 rounded-2xl shadow-xl flex items-center gap-3 border border-slate-700/50 max-w-[240px] hover:-translate-y-1 transition-transform sm:mb-2">
              ...
              <div>
                <div className="text-xs font-bold mb-0.5 leading-tight">Secure. Scalable. Smart.</div>
                <div className="text-[9px] text-slate-300 leading-tight">Built for excellence.</div>
              </div>
            </div>
          </div>
        </section>
